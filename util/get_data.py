...
def get_voxel_data(num_points_pc: int, track_point_index: int):
    ...
    _, pcd_train, y_train = get_all_trajectories(train_data, track_point_index, num_points_pc)
    pcd_train, y_train = join_trajectories(pcd_train), join_trajectories(y_train)

    _, pcd_test, y_test = get_all_trajectories(test_data, track_point_index, num_points_pc)
